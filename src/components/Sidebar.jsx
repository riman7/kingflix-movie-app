    ...
    return(
        ...
        ">
            ...
            <div className='space-y-3'>
                ...
                <div className='flex space-x-4 items-center cursor-pointer pl-3 border-l-2 border-amber-400 text-amber-400'><HomeIcon className='size-5 text-amber-400' /> <span>Home</span></div>
